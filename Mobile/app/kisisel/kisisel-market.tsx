    ...
    <SafeAreaView style={[styles.safeArea, currentTheme === 'dark' && { backgroundColor: '#0f172a' }]}>
      ...
      >
        <TouchableOpacity
          ...
          onPress={() => router.push('/market-map?type=kisisel')}
          activeOpacity={0.8}
        >
        ...
        <View style={[styles.infoBox, currentTheme === 'dark' && { backgroundColor: '#1e293b' }]}>
          ...
          <Text style={[styles.infoSubtitle, currentTheme === 'dark' && { color: '#94a3b8' }]}>Doğayı koru, geleceği dönüştür! Atıklarını çöpe değil geleceğe yatır, dönüştürdükçe kazanmaya hemen başla!</Text>
        </View>
