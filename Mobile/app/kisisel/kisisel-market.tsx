  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.topBar}>
        <Text style={styles.headerTitle}>Atık Marketi</Text>
      ...
      >
        <View style={styles.infoBox}>
          ...
          <Text style={styles.infoSubtitle}>Doğayı koru, geleceği dönüştür! Atıklarını çöpe değil geleceğe yatır, dönüştürdükçe kazanmaya hemen başla!</Text>
        </View>
